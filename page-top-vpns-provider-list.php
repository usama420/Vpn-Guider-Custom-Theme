<?php get_header(); ?>
    ...
    <div class="pageWrapper" id="top-reviews">
        <div class="page-header">
            <div class="container">
                <h1>Top VPNs Provider List</h1>
                <p>List of all the VPN we have reviewed</p>
            </div>
        </div>

        <section class="top-vpn-cards">
            <div class="container">
                <?php 
				$selectedTop = get_field('select_vpns');
					$paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
    				$args = array(
    					'post_type' => 'vpn',
						'posts_per_page' => 5,
        				'paged' => $paged,
	     				'post__in' => $selectedTop,
    				);
